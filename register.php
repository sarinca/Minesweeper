...
<head>
    ...
    <meta property="og:description" content="Website for CS 4750 hosting a Minesweeper website.">
                ...
                <nav class="nav flex-column">
                    <ul class="vertical-nav">
                        ...
                        <?php if ($user_loggedIn == true) {
                            echo "<a class='nav-link' href='?command=play'>Play</a>";
                        } ?>
                        <?php if ($user_loggedIn == true) {
                    ...
                    <div class="card bg-transparent border-0 p-4" style="width: 900px; height: 375px;">
                        <form id="register" method="post">
                            <div class="form-group mb-4">
                                ...
                                <input type="text" id="username" class="form-control rounded-pill" name="username"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" id="email" class="form-control rounded-pill" name="email"
                                    placeholder="name@example.com" required>
                            </div>

                            <div class="form-group mb-4">
                                <label for="password" class="form-label">Password</label>
                                <input type="password" id="password" class="form-control rounded-pill" name="password"
                                    placeholder="Enter password" required>
                                <div id="passwordHelpBlock" class="form-text d-none">
                                    Your password must contain a minimum of eight characters and at least one uppercase
                                    letter, one lowercase letter, one number, and one special character.
                                </div>
                            </div>
                            <button type="submit" class="btn rounded-pill loginbtn w-100"
                                style="background-color: #fbe9af; border-color: #fbe9af;">Register</button>
                        </form>
                        <div class="text-center mt-3">
                            <p>Already have an account? <a href="login.php" class="text-decoration-none">Log in here</a>
                            </p>
                        </div>
                    </div>
                </div>
